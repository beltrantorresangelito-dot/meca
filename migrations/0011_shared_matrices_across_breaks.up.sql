-- ============================================================
-- MECA F11.6.4
-- Permitir que una matriz sea utilizada por campañas
-- pertenecientes a distintos quiebres.
--
-- IMPORTANTE:
-- - No modifica datos existentes.
-- - matrices.quiebre_id se conserva como quiebre de origen.
-- - campana_matriz pasa a ser la relación funcional efectiva.
-- ============================================================
...
BEGIN
    ...
    --      m.quiebre_id = q.id
    --
    -- porque una matriz puede ser compartida por campañas
    -- pertenecientes a quiebres distintos.
    -- ========================================================
    RETURN QUERY
    SELECT
        q.id::BIGINT,
...
'Quiebre de origen de la matriz. No restringe qué campañas o quiebres pueden utilizarla; la asignación efectiva se gestiona mediante campana_matriz.';
